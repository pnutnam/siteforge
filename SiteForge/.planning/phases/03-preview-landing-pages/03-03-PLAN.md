...
<task type="auto">
  ...
  <files>src/preview/analytics/types.ts, src/preview/analytics/tracker.ts, src/preview/analytics/events.ts, src/preview/analytics/stats.ts, src/database/schema.ts</files>
  <read_first>
    - src/preview/links/manager.ts (PreviewLinkStats interface)
    - src/database/schema.ts (preview_links table, for adding analytics_events)
  </read_first>
  <action>
...
Add analytics_events table to src/database/schema.ts:
...
import { pool } from '../../database/pool';
import { analyticsEvents } from '../../database/schema';  // Import from schema
import { pgTable, uuid, text, timestamp, jsonb, index } from 'drizzle-orm/pg-core';

// Note: analyticsEvents table is now defined in src/database/schema.ts
// This file imports and re-exports for convenience
